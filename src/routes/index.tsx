...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "Chá Revelação · Lucca Miguel ou Maria Cecília?" },
      {
        name: "description",
        content:
          "Convite para o nosso Chá Revelação · 25/04/2026 · Diadema. Venha descobrir conosco se será Lucca Miguel ou Maria Cecília!",
      },
      { property: "og:title", content: "Chá Revelação · Será Lucca Miguel ou Maria Cecília?" },
      {
        property: "og:description",
        content: "25 de abril de 2026, 11h30 — Diadema. Confirme sua presença 💛",
      },
    ],
  }),
  component: Index,
...
function openLocation() {
  ...
  // Fallback after short delay if Waze didn't load (heuristic for desktop without Waze)
  setTimeout(() => {
    try {
      if (w.closed === false) return;
    } catch {
      /* cross-origin */
    }
  }, 1500);
